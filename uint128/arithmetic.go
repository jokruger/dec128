...
func (self Uint128) Add(other Uint128) (Uint128, error) {
...
func (self Uint128) Add64(other uint64) (Uint128, error) {
...
func (self Uint128) Sub(other Uint128) (Uint128, error) {
...
func (self Uint128) Sub64(other uint64) (Uint128, error) {
...
func (self Uint128) Mul(other Uint128) (Uint128, error) {
...
func (self Uint128) Mul64(other uint64) (Uint128, error) {
...
func (self Uint128) Div(other Uint128) (Uint128, error) {
	q, _, err := self.QuoRem(other)
	return q, err
}

func (self Uint128) Div64(other uint64) (Uint128, error) {
	q, _, err := self.QuoRem64(other)
	return q, err
}

func (self Uint128) Mod(other Uint128) (Uint128, error) {
	_, r, err := self.QuoRem(other)
	return r, err
}

func (self Uint128) Mod64(other uint64) (uint64, error) {
	_, r, err := self.QuoRem64(other)
	return r, err
}

func (self Uint128) QuoRem(other Uint128) (Uint128, Uint128, error) {
	if other.IsZero() {
...
func (self Uint128) QuoRem64(other uint64) (Uint128, uint64, error) {
	if other == 0 {
		return Zero, 0, ErrDivByZero
	}
