...
func TestGlobalFreeSubset(t *testing.T) {
	...
	free := []struct {
		...
		{"MulPercentRound", func(a, b Dec128) Dec128 { return a.MulPercentRound(b, 6, ROUND_BANK) }},
		{"MulScaledRound", func(a, b Dec128) Dec128 { return a.MulScaledRound(b, -4, 6, ROUND_BANK) }},
		{"MulScaledRound wide", func(a, b Dec128) Dec128 { return a.MulScaledRound(b, -6, MaxScale, ROUND_BANK) }},
		{"MulScaledRound up", func(a, b Dec128) Dec128 { return a.MulScaledRound(b, 4, 0, ROUND_BANK) }},
...
func TestGlobalFreeSubsetIsNotVacuous(t *testing.T) {
	...
	bound := []struct {
		...
		{"MulScaled", func() Dec128 { return wide2.MulScaled(wide2, -3) }},
		{"MulPercent", func() Dec128 { return wide2.MulPercent(wide2) }},
