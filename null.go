...
//
// By default a NULL scans to Zero, which is what this package has always done. That loses the distinction between
// "no amount recorded" and "the amount is zero", so the value produced for NULL is configurable:
//
